...
단순 팩트 나열을 완전히 배제하고, "오늘 시장을 주도한 테마의 자금 흐름과 특징, 수급 주체의 의도, 내일장 대응 전략"을 1,500자 이상의 논리적이고 입체적인 전문 리포트 형식으로 완벽하게 다듬어 작성해야 해.
...
1. 제목은 <h1>[장마감 브리핑] 오늘 시장을 주도한 핵심 테마 자금 흐름 & 거래대금 쏠림 종목 심층 분석</h1> 형태로 작성.

2. 본문 서두에 📊 [오늘의 주도 테마 & 자금 흐름 스코어보드]:
   본문 시작부에 방문자가 한눈에 볼 수 있는 깔끔한 요약 HTML <table>을 배치할 것.
...
4. 3대 심층 논리 분석 섹션 (<h2> 태그 - 각 섹션마다 단순 나열을 금지하고 풍부한 서술형 분석문 작성):
   - <h2 style="color:#0f172a; border-bottom:2px solid #e2e8f0; padding-bottom:8px; margin-top:35px;">1. 주도 테마 심층 분석: 자금 쏠림의 배경과 산업 모멘텀</h2>
     * 단순히 "어떤 테마가 올랐다"는 나열을 절대 금지하고, 오늘 상위 테마군으로 막대한 유동성이 집중된 거시적 이유와 산업적 재료를 인과관계 중심으로 최소 2~3개 문단으로 깊이 있게 서술할 것.
     * 기관 및 외국인 수급의 매수 지속 가능성을 함께 평가할 것.
   - <h2 style="color:#0f172a; border-bottom:2px solid #e2e8f0; padding-bottom:8px; margin-top:35px;">2. 거래대금 1,000억+ 집중 종목과 스마트머니 수급 특징</h2>
     * 1,000억 원 이상 유동성이 폭발한 상위 종목들을 묶어, 단순 단기 테마성 급등인지 아니면 스마트머니(외인/기관)의 추세적 매집인지 차익실현 물량 출회인지 자금 흐름 관점에서 날카롭게 진단할 것.
     * 종목별 주가 지지 라인과 수급의 연속성을 분석할 것.
   - <h2 style="color:#0f172a; border-bottom:2px solid #e2e8f0; padding-bottom:8px; margin-top:35px;">3. 시장 전반적인 수급 순환매 & 내일장 실전 대응 시나리오</h2>
     * 오늘 자금 유입 테마의 익일 갭상승 후 차익실현 가능성, 소외 섹터로의 순환매 가능성, 개인 투자자가 주의해야 할 뇌동매매 방지 팁과 실전 비중 관리 전략을 구체적으로 제시할 것.
...
5. 📅 [오늘 밤 & 내일 글로벌 핵심 경제 캘린더 프리뷰] (★ 매우 중요):
   ...
   - 반드시 </table> 및 </div> 태그를 끝까지 완벽하게 닫을 것.
   - 테이블 아래에 [전문가 관점의 시장 파급 시나리오]:
     * 오늘 밤 발표될 주요 경제 지표 결과가 내일 한국 증시의 시초가 갭상승/갭하락과 원/달러 환율에 미칠 파급 효과를 논리적으로 2~3개 문단 서술할 것.
...
6. 📰 [네이버 증권 핵심 뉴스 TOP 3~5선]:
   ...
   - 제공된 네이버 뉴스 데이터를 바탕으로, 각 기사마다 
     <p style="margin-bottom:12px;"><strong>• <a href="기사링크" target="_blank" style="color:#2563eb; text-decoration:none;">기사 제목</a></strong> <small style="color:#64748b;">(언론사)</small><br>기사 핵심 요약 내용 및 시장 시사점</p>
